...
public class CommandNoteController {
	...
	@ApiImplicitParams({@ApiImplicitParam(name = "token", value = "用户凭证", paramType = "header", dataType = "String"),
		...
		@ApiImplicitParam(name = "unitid", value = "单元标识", paramType = "form", dataType = "String"),
		@ApiImplicitParam(name = "app", value = "用户类型", paramType = "form", dataType = "String"),
		@ApiImplicitParam(name = "deviceid", value = "设备标识", paramType = "form", dataType = "String"),
		@ApiImplicitParam(name = "visittime", value = "预约时间", paramType = "form", dataType = "Long")})
