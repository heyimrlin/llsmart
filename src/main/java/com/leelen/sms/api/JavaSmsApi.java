 ...
 * @time 2018年6月14日上午11:29:33
 * @class JavaSmsApi.java
 */
...
public class JavaSmsApi {
	...
	// 智能匹配模板发送接口的http地址
	private static String URI_SEND_SMS = "https://sms.yunpian.com/v2/sms/single_send.json";// 短信接口 访问方式：POST
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		...
		String apikey = "cd219f1e35f49c23e2e073dd8dac443d";// 公司专用 个人:463a483e60809246adc41eaae3f5a5c2

		// 修改为您要发送的手机号
		String mobile = "15359253734";
		...
		String codeStr = Ramdata.ramdaSw(6);
		System.out.println("codeStr:" + codeStr);
		String text = "【小易开门】您的验证码是" + codeStr + "。请在1分钟内完成验证。";
		// 发短信调用示例
		...
		// + URLEncoder.encode("#company#", ENCODING) + "=" + URLEncoder.encode("小易开门",
		// ENCODING);
		// 模板发送的调用示例
	...
	public static String getText(String code, int min) {
		return "【小易开门】您的验证码是" + code + "。请在" + min + "分钟内完成验证。";
	}
	...
	// public static String bindCall(String apikey, String from, String to, Integer
	// duration) {
	// Map<String, String> params = new HashMap<String, String>();
	// params.put("apikey", apikey);
	...
	public static String post(String url, Map<String, String> paramsMap) {
		...
		try {
			...
			System.out.println("解析:" + json.getString("code") + json.getString("msg"));
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			try {
	...
	// sendSms("cd219f1e35f49c23e2e073dd8dac443d", "【小易开门】您的验证码是1234。请在1分钟内完成验证。",
	// "15359253734");
	// }
}