...
public class AdministratorController {
	...
	@ApiImplicitParams({@ApiImplicitParam(name = "accounttell", value = "用户手机号", paramType = "form", dataType = "String", required = true),
	...
	@ApiImplicitParams({@ApiImplicitParam(name = "token", value = "用户凭证", paramType = "header", dataType = "String", required = true),
		@ApiImplicitParam(name = "oldpwd", value = "原始密码", paramType = "form", dataType = "String", required = true),
		...
		@ApiImplicitParam(name = "smsCode", value = "短信验证码", paramType = "form", dataType = "String", required = true)})
	...
	@ApiImplicitParams({@ApiImplicitParam(name = "token", value = "用户凭证", paramType = "header", dataType = "String", required = true),
		@ApiImplicitParam(name = "sign", value = "URL签名", paramType = "header", dataType = "String", required = true),
		@ApiImplicitParam(name = "tell", value = "需要绑定的手机号", paramType = "form", dataType = "String", required = true)})
	...
	@ApiImplicitParam(name = "roleid", value = "角色标识", paramType = "form", dataType = "String", required = true)
