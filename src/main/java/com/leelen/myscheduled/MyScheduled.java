 ...
 * @time 2018年6月27日下午5:19:28
 * @class MyScheduled.java
 */
...
public @interface MyScheduled {
	 ...
	 * of week. e.g. {@code "0 * * * * MON-FRI"} means once per minute on weekdays
	 ...
	 * attribute is the empty String (i.e. the server's local time zone will be
	 * used).
	 * 
